...
Unfortunately, all of my results are [currently locked on WandB](/blog/posts/research_workflows/#running-and-managing-experiments) so I'm going to spend the rest of the week setting up a new locally hosted experiment tracking system so that I can share my results more easily (and then re-run all my key experiments). And once that's set up, the idea I'd like to try going forward is to publish all of my experiments and incremental results publicly as I go along. I don't expect anyone to read this, but I think once we finally get the project page up and running in a few weeks, I can link back to these posts and it'll be a nice way to see the evolution of the project.